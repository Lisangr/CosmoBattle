...
public class Player : MonoBehaviour
{
    ...
    public float leftBoundaryOffset; // Отступ от левой границы камеры
    ...
    private void Update()
    {
        ...
        if (!PauseActivator.isPaused && !TimerBeforeAdsYG.inPausing)
        {
            ...
            // Ограничиваем положение игрока в пределах камеры
            ...
            // Ограничение по горизонтали с учётом отступа
